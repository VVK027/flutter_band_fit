...
class ActivityMonitorController extends GetxController {
  final GetActivityMonitorSettingsUseCase _getSettingsUseCase = Get.find<GetActivityMonitorSettingsUseCase>();
  final SaveActivityMonitorSettingsUseCase _saveSettingsUseCase = Get.find<SaveActivityMonitorSettingsUseCase>();
