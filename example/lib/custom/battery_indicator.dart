...
class BatteryIndicator extends StatefulWidget {
  ...
  const BatteryIndicator(
      {Key? key, this.batteryFromPhone = true,
        ...
        child: Center(
          child: Padding(
            ...
            child: widget.showPercentNum
                ? Text('$batteryLv%',
              style: TextStyle(fontSize: widget.percentNumSize ?? widget.size * 0.9))
...
class BatteryIndicatorPainter extends CustomPainter {
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    return (oldDelegate as BatteryIndicatorPainter).batteryLv != batteryLv || (oldDelegate  as BatteryIndicatorPainter).mainColor != mainColor;
  }
